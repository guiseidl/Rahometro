  ...
  return (
    <div className="bg-[#121212] min-h-screen flex flex-col">
      ...
      <div className="flex justify-center pt-8">
        ...
        <div className="w-full max-w-6xl px-6 py-8 flex justify-between space-x-4">
          {" "}
          {/* Alterado para usar flex em linha */}
          {/* Card Gerenciar Usuários */}
          <div className="bg-[#1F1F1F] p-6 rounded-lg shadow-lg text-center w-1/3">
            <h3 className="text-white text-xl mb-4">Controle de Despesas</h3>
            <p className="text-[#BBBBBB] mb-4">
              Aqui você pode gerenciar todas as despesas e pagamentos dos
              eventos.
            </p>
            <Link
              to="/controle-de-despesas"
          ...
          <div className="bg-[#1F1F1F] p-6 rounded-lg shadow-lg text-center w-1/3">
            ...
            <p className="text-[#BBBBBB] mb-4">
              Aqui você pode gerenciar eventos criados por usuários.
            </p>
            <Link
              to="/events"
              className="bg-gray-600 text-white py-2 px-4 rounded-md hover:bg-gray-700"
          ...
          <div className="bg-[#1F1F1F] p-6 rounded-lg shadow-lg text-center w-1/3">
            ...
            <p className="text-[#BBBBBB] mb-4">
              Acesse relatórios sobre o desempenho do sistema.
            </p>
            <Link
              to="/reports"
              className="bg-gray-600 text-white py-2 px-4 rounded-md hover:bg-gray-700"
